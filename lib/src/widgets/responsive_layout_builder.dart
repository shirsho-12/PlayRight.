import 'package:play_right/src/layout/layout.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= PlayRightBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= PlayRightBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= PlayRightBreakpoints.large) {
